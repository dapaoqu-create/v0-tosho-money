          ...
          <div className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <h3 className="mb-2 font-semibold">{t("csvImport")}</h3>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <h3 className="mb-2 font-semibold">{t("autoReconciliation")}</h3>
                <p className="text-sm text-muted-foreground">{t("autoReconciliationDesc")}</p>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <h3 className="mb-2 font-semibold">{t("statsReports")}</h3>
                <p className="text-sm text-muted-foreground">{t("statsReportsDesc")}</p>
              </div>
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <h3 className="mb-2 font-semibold">{t("userManagement")}</h3>
